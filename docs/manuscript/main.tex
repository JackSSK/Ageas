...
\section*{Results}
  ...
  The extraction result is summarized as TF regulons, collections of a TF and corresponding direct regulatory targets, in ... % fig ../images/mef_esc.png
  ...
  %       \hline
  %
  %       Pou5f1 (Oct4) & ESC & 13.36 & The Yamanaka factor\cite{yamanaka_2006} \\
  %       \hline
  %       Cebpb & MEF & 2.24 & part of the AP-1 complex network \\
  %       \hline
  %       Nanog & ESC & 10.46 & Can reprogram MEF into iPSC with other GFs\cite{ips7f, oct4_nanog_sox2_lin28, oct4_nanog_sox2} \\
  %       \hline
  %       Sox2 & ESC & 9.64 & The Yamanaka factor\cite{yamanaka_2006} \\
  %       \hline
  %       Junb & MEF & 0.17 & Subunit of AP-1 which can prohibit iPSC reprogramming\cite{ips7f, ipsAP1} \\
  %       \hline
  %       Jun & MEF & 0.45 & Subunit of AP-1 which can prohibit iPSC reprogramming\cite{ips7f, ipsAP1} \\
  %       \hline
  %       Jund & ESC & 1.38 & Subunit of AP-1 which can prohibit iPSC reprogramming\cite{ips7f, ipsAP1} \\
  %       \hline
  %       Hdca2 & ESC & 1.01 & Knockdown of Hdac2 improves OSKM-mediated iPS cell generation \\
  %       \hline
  %       Twist2 & MEF & 3.64 & fibroblastic master gene\\
  %       \hline
  %       Fos & MEF & 0.58 & Subunit of AP-1 which can prohibit iPSC reprogramming\cite{ips7f, ipsAP1} \\
  %       \hline
  %       Klf4+39 & ESC & 2.71 & The Yamanaka factor\cite{yamanaka_2006} \\
  %
  %       \hline
  %     \end{tabular}
  %     \caption{
  %       \label{mef_esc_result}
  %       In total of 47 Genes
  %     }
  % \end{table}
  %
  % \begin{table}[ht]
  ...
  %       Fosl2 & 8 & 0.64 & sss \\
  %       \hline
  %       Nkx2-5 & 9 & 0.06 & cardiac-specific structural genes\\
  %       \hline
  %       Rest & 10 & 1.67 & sss \\
  %
  %
  ...
  %     \end{tabular}
  %     \caption{
  %       \label{CMp7p28_result}
  %       In total of 119 Genes
  %     }
  % \end{table}
  %
  %
