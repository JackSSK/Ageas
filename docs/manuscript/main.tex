...
\section*{Results}
  ...
  From extracted TFs shown in Figure \ref{result_figs}(b), we hypothesize ISL1, PHOX2B, and ELF3, referring to their correspond regulon sizes and expression changes, are regulating essential functions differentiating DA neurons from neural progenitors.
  ...
  Following same regulon size and expression change based analytical procedure, we primarily investigated three TFs shown in Figure \ref{result_figs}(c): Sp1, Esr1 ($ER\alpha$), and Cebpb.
  ...
  Other TFs known playing important roles in CM maturation, such as Srf\cite{CM_mature, cebpb_1}, Nkx2-5\cite{cebpb_1, nkx25}, and Yap1\cite{CM_mature, yap1}, are also forming sizeable regulons in GRN atlas returned by \emph{AGEAS} .
  ...
  Within TFs shown in Figure \ref{result_figs}(d), we suppose Lhx2, Osr1, and Ebf1 are regulating phenotypes clearly differentiating HSCs from PFs considering their correspond TF regulon sizes and expression changes.

  Osr1 fibrogenic regulation

  Ebf1 ...

  Lhx2 halt quiescent HSCs

  Furthermore, Mef2c forming top TF regulon is main regulator of collagen expression...
  ...
  Since Lhx2 has largest expression change while favoring in HSCs...
  but not directly regulating fibrogenic genes as Mef2c does...
  in vitro experiment overexpression of Lhx2 repressing HSC activation...
